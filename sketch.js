...
function preload(){
    ...
    hotairballoon = loadAnimation("Sprites/Hot Air Ballon-02.png", "Sprites/Hot Air Ballon-03.png", "Sprites/Hot Air Ballon-04.png")
...
function draw() {
  ...
  fill("purple");
  textSize(25);
  text("Use the arrow keys to move the Hot Air Balloon", 20, 30);
